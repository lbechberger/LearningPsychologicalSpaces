...
Research based on an earlier version of this repository has been presented at [AIC 2018](http://aic2018.pa.icar.cnr.it/): 
...
The script `code/shell_scripts/pipeline_NOUN.py` automatically executes all scripts necessary to reproduce our results. It calls the following five shell scripts which make up the five processing steps in our setup:
...
#### 2.1.2 Parsing Shapes CSV Files
...
#### 2.1.6 Writing CSV Files of Aggregated Dissimilarities
