...
Rscript code/mds/data_analysis/analyze_visual_conceptual.r -c data/Shapes/mds/data_set/individual/similarities/conceptual_10.csv -v data/Shapes/mds/data_set/individual/similarities/visual_10.csv
