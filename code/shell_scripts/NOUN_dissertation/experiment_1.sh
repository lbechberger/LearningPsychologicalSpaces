...
do
	echo "        $baseline"	
	$cmd $script data/NOUN/dataset/targets.pickle HorstHout_4 data/NOUN/dataset/features_ANN.pickle data/NOUN/dataset/folds.csv data/NOUN/ML_results/experiment_1/baselines.csv -s 42 $baseline
done
