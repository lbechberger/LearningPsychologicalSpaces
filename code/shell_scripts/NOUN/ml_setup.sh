...
python -m code.ml.regression.pixel_features data/NOUN/ml/dataset/augmented/ data/NOUN/ml/dataset/features_pixel_1875.pickle -b 12 -a min
python -m code.ml.regression.pixel_features data/NOUN/ml/dataset/augmented/ data/NOUN/ml/dataset/features_pixel_507.pickle -b 24 -a min
